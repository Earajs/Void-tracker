export class DonateMessages {
  ...
  static donateMessage(userWallet?: string | undefined): string {
    const messageText = `
⭐ <b>Support the future of Void</b>
...
To donate:
1️⃣ Send any amount of <b>SOL</b> to your <b>Void wallet</b>.
...
<b>Your Void wallet:</b> <code>${userWallet ? userWallet : ''}</code>
`
...
Your support helps keep Void growing and improving, allowing us to bring you exciting new features and better services.
