...
${
  changedStatus === 'PAUSED'
    ? `
✨ Void has been <u>Paused</u> and you will no longer receive notifications until you resume it!
    
You can still resume the bot anytime in the settings menu
`
    : changedStatus === 'ACTIVE'
      ? `
✨ Void has been <u>Resumed</u> and you will start receiving notifications again!
